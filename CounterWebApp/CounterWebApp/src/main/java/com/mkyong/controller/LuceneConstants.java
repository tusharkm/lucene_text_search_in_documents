...
public static final String CONTENTS="contents";
	...
	public static final String indexPath = "indexedFiles";// Path for the Index folder
	
	public static final String FILE_PATH="filepath";
	
	public static final int MAX_SEARCH = 10;
	public static final String INDEX_DIR= "C:\\Users\\Tushu\\Downloads\\CounterWebApp\\CounterWebApp\\indexedFiles";
	public static final String docsPath = "inputFiles";// Path for the I/P folder
	
	public static final List<String> stopWords= Arrays.asList("a", "a's", "able", "about", "above", "according",
